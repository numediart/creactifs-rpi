...
\extras{\includegraphics[height=25pt]{title/creactifs}}
\date{16 mars 2026}
...
\begin{frame}{Accéder à Home Assistant}
    ...
    \begin{itemize}
        \item \texttt{http://hostname.local:8123} ou
...
\begin{frame}[fragile]{Configuration de la caméra RTSP}
    ...
    \end{lstlisting}
        ...
        \item Configuration de MediaMTX pour lire la caméra du Raspberry Pi
              \begin{itemize}
                  \item ouvrir \texttt{\textasciitilde/mediamtx/mediamtx.yml} (avec
                        \cmd{nano}),
...
\begin{frame}[fragile]{Activation du service}{Utilisation de systemctl}
    ...
    \alert{Attention}: le service ne peut pas se lancer si MediaMTX tourne dans un terminal!
\end{frame}
...
\begin{frame}{Étendre les capacités de Home Assistant}
    \begin{columns}[t]
        ...
        \begin{column}{.45\textwidth}
            ...
            \href{https://esphome.io/}{\includegraphics[width=.7\textwidth]{esphome}}
            ...
            \href{https://tasmota.github.io/}{\includegraphics[width=.5\textwidth]{tasmota}}
